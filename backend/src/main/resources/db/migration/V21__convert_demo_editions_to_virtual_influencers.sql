...
SET
    ...
    avatar_url = '/demo-assets/astra-vale-avatar.png',
    verified = TRUE
WHERE id = 1;
...
SET
    ...
    avatar_url = '/demo-assets/mina-loop-avatar.png',
    verified = TRUE
WHERE id = 2;
...
SET title = '사막 초상 무드컷', content = '/demo-assets/astra-vale-story-1.png'
WHERE edition_version_id = 1 AND sort_order = 1;

UPDATE curated_asset
SET title = '야간열차 플랫폼의 노트', content = '/demo-assets/astra-vale-story-1.png'
...
UPDATE curated_asset
SET title = '언덕 위 로드트립 컷', content = '/demo-assets/mina-loop-story-1.png'
...
UPDATE curated_asset
SET title = '야간 스튜디오 하이라이트', content = '/demo-assets/noah-reed-story-1.png'
