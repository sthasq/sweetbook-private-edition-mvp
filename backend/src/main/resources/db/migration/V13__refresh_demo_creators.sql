...
VALUES
    (1, '빠니보틀', '@PaniBottle', '/demo-assets/panibottle-avatar.svg', TRUE, 1, CURRENT_TIMESTAMP(6)),
    (2, '곽튜브', '@JBKWAK', '/demo-assets/jbkwak-avatar.svg', TRUE, NULL, CURRENT_TIMESTAMP(6)),
    (3, '침착맨', '@chimchakman_official', '/demo-assets/chimchakman-avatar.svg', TRUE, NULL, CURRENT_TIMESTAMP(6))
...
UPDATE app_user
SET display_name = '빠니보틀'
WHERE email = 'creator@playpick.local';

UPDATE edition
SET
    creator_id = 1,
    title = '빠니보틀 세계여행 메모리북 데모',
    subtitle = '빠니보틀 공개 채널 감성으로 구성한 비공개 과제용 트래블 굿즈 데모',
...
SET
    creator_id = 2,
    title = '곽튜브 로드트립 팬레터북 데모',
    subtitle = '곽튜브 공개 채널 분위기를 바탕으로 만든 비공개 과제용 메시지북 데모',
...
SET
    creator_id = 3,
    title = '침착맨 토크 하이라이트북 데모',
    subtitle = '침착맨 공개 채널 감성을 참고한 비공개 과제용 하이라이트북 데모',
...
SET
    official_intro = JSON_OBJECT(
        ...
        'message', '빠니보틀 채널의 여행 무드를 바탕으로, 팬이 고른 장면과 개인 메모를 한 권으로 묶는 데모 메모리북입니다.'
    ),
...
SET
    official_intro = JSON_OBJECT(
        ...
        'message', '곽튜브 채널에서 느낀 에피소드 감도를 팬 메시지와 함께 쌓아가는 비공개 과제용 팬레터북 데모입니다.'
    ),
    official_closing = JSON_OBJECT(
...
SET
    official_intro = JSON_OBJECT(
        ...
        'message', '침착맨 채널의 토크와 하이라이트 감상을 팬의 시선으로 다시 엮는 비공개 과제용 리캡북 데모입니다.'
    ),
    official_closing = JSON_OBJECT(
