...
| **외부 연동** | Sweetbook Books/Orders API, Toss Payments, OpenRouter (AI 채팅), 향후 확장용 소셜 인증/API 연동 |
...
| `OPENROUTER_API_KEY` | LLM 개인화 채팅용 | — |
| `OPENROUTER_CHAT_MODEL` | 개인화 채팅용 텍스트 모델 | `google/gemini-3-flash-preview` |
