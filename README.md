...
> Sweetbook Books API · Orders API를 활용해, 인플루언서가 공식 에디션을 발행하고 팬이 자신의 이야기를 더해 실물 포토북을 주문하는 풀스택 플랫폼입니다.
...
PlayPick은 인플루언서가 직접 구성한 포토북 **에디션**을 팬이 둘러보고, 자신의 문장·사진·추억을 더해 개인화한 뒤 실물 포토북으로 주문하는 플랫폼입니다.
...
| **개인화** | 닉네임, 메시지, 사진, 추억, 좋아하는 장면 등을 입력 |
